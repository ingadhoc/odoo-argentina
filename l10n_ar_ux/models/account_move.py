...
class AccountMove(models.Model):
    ...
    def _post(self, soft=True):
        ...
        other_currency_ar_invoices.filtered(lambda x: not x.l10n_latam_use_documents)._set_afip_rate()
    ...
    def _set_afip_rate(self):
        """  Overwrite completely only to force a write to re compute rates """
        for rec in self:
