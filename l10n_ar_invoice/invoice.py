...
class account_invoice(osv.osv):
    ...
    # def _get_available_document_class_ids(self, cr, uid, ids, field_name, arg, context=None):
        if context is None:
            context = {}
        result = {}
        for invoice in self.browse(cr, uid, ids, context=context):
    ...
    _columns = {
        ...
        # 'available_document_class_ids': fields.function(_get_available_document_class_ids, relation='afip.document_class', type='many2many', string='Available Document Classes'),
    ...
    def onchange_journal_id(self, cr, uid, ids, journal_id=False, partner_id=False, context=None):
        ...
        if journal_id and partner_id:
            ...
            domain = [('journal_id','=',journal_id),('afip_document_class_id.document_letter_id','in',letter_ids)]
    ...
    def create(self, cr, uid, vals, context=None):
        ...
        if journal_id and partner_id:
            ...
            if journal_document_class_ids:
                ...
                # vals['journal_document_class_ids'] = journal_document_class_ids[0]
            # if 'domain' not in result: result['domain'] = {}        
            # result['domain']['journal_document_class_id'] = [('id', 'in', journal_document_class_ids)]  
        # result['value']['journal_document_class_id'] = journal_document_class_id
...
# Ver si la necesito para el resto
    ...
    # def get_valid_document_class(self, cr, uid, partner_id, journal_type, company_id=False, context=None):
        ...
        # Now we check if the company has mapping
        if map_invoice:
