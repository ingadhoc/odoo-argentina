...
class Parser(rml_parse):
    def __init__(self, cr, uid, name, context):
        ...
        report_id = report_obj.search(cr, uid, [('report_name','=',name)], context=context)
        ...
        self.localcontext.update({'use_background_image': report.use_background_image})
        if report.use_background_image:
            self.localcontext.update({'background_image': report.background_image})
            print 'background_image', report.background_image
        else:
