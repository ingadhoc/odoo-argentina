...
class AccountChartTemplate(models.AbstractModel):
    ...
    def _add_wh_taxes(self, company):
        ...
        tax_state_tupples = [
            ...
            ('ri_tax_withholding_iibb_ca_incurred', 'base.state_ar_k'),
            ('ri_tax_withholding_iibb_co_incurred', 'base.state_ar_x'),
            ('ri_tax_withholding_iibb_rr_incurred', 'base.state_ar_w'),
            ('ri_tax_withholding_iibb_er_incurred', 'base.state_ar_e'),
            ('ri_tax_withholding_iibb_ju_incurred', 'base.state_ar_y'),
            ('ri_tax_withholding_iibb_za_incurred', 'base.state_ar_m'),
            ('ri_tax_withholding_iibb_lr_incurred', 'base.state_ar_f'),
            ('ri_tax_withholding_iibb_sa_incurred', 'base.state_ar_a'),
            ('ri_tax_withholding_iibb_nn_incurred', 'base.state_ar_j'),
            ('ri_tax_withholding_iibb_sl_incurred', 'base.state_ar_d'),
            ('ri_tax_withholding_iibb_sf_incurred', 'base.state_ar_s'),
            ...
            ('ri_tax_withholding_iibb_ca_applied', 'base.state_ar_k'),
            ('ri_tax_withholding_iibb_co_applied', 'base.state_ar_x'),
            ('ri_tax_withholding_iibb_rr_applied', 'base.state_ar_w'),
            ('ri_tax_withholding_iibb_er_applied', 'base.state_ar_e'),
            ('ri_tax_withholding_iibb_ju_applied', 'base.state_ar_y'),
            ('ri_tax_withholding_iibb_za_applied', 'base.state_ar_m'),
            ('ri_tax_withholding_iibb_lr_applied', 'base.state_ar_f'),
            ('ri_tax_withholding_iibb_sa_applied', 'base.state_ar_a'),
            ('ri_tax_withholding_iibb_nn_applied', 'base.state_ar_j'),
            ('ri_tax_withholding_iibb_sl_applied', 'base.state_ar_d'),
            ('ri_tax_withholding_iibb_sf_applied', 'base.state_ar_s'),
